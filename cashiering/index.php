...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <script>
        ...
        function loadWIDataBase() {
            var data = `request_type=loadWIDataBase`;
            ajax_request(data).done(function(request) {
                var response = JSON.parse(request);

                var tableHead = `
                    <tr>
                        <th width="15%" style="text-align:center;">Reservation #</th>
                        <th width="15%">Room</th>
                        <th width="20%">Guest Name</th>
                        <th width="15%">Adult / Child</th>
